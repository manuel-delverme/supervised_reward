...
def get_weight_evolution_fitness_fn(SIDE_SIZE, nr_options, plot_progress=False):
    ...
    def fitness_simple_boxes(reward_vector):
        ...
        for eval_step, box_positions in enumerate(possible_box_positions):
            option_set_scores = e.BoxWorldSimple.eval_option_on_mdp(SIDE_SIZE, TEST_MAX_STEPS_EVAL, box_positions, options, xs)
        ...
        fitness = sum(cum_cum_reward)
        # print("score:\t{}\toptions: nr:{}\tnames:{}".format(fitness, len(options), option_names))
