...
class MultiRoomEnv(MiniGridEnv):
    ...
    def __init__(self,
        ...
        super(MultiRoomEnv, self).__init__(
            ...
            see_through_walls=config.see_trough_walls,
            seed=config.seed,
        )
...
class MultiRoomEnvN2S1(MultiRoomEnv):
    def __init__(self):
        super().__init__(
            minNumRooms=2,
            maxNumRooms=2,
...
class MultiRoomEnvN2S6(MultiRoomEnv):
    def __init__(self):
        super().__init__(
            minNumRooms=2,
            maxNumRooms=2,
...
register(
    id='MiniGrid-MultiRoom-N2-S1-v0',
    entry_point='gym_minigrid.envs:MultiRoomEnvN2S1',
